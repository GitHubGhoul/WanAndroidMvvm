...
import com.wxd.wanandroidmvvm.base.BaseVmActivity
import com.wxd.wanandroidmvvm.base.BaseVmFragment
import com.wxd.wanandroidmvvm.http.response.*
...
fun <T> BaseVmActivity<*>.parseState(
    ...
    when (resultState) {
        is ResultState.Loading -> {
            showLoadingExt(resultState.loadingMessage)
            onLoading?.run { this }
        }
